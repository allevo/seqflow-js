...
export class ProductDomain {
  ...
  async fetchProductsByCategory({ categoryId }: { categoryId: string }, signal: AbortSignal): Promise<Product[]> {
    const res = await fetch(`https://fakestoreapi.com/products/category/${categoryId}`, { signal })
